...
const TYPE_MOVEMENT_REGULARIZE = 5;
const TYPE_MOVEMENT_MOVE       = 6;
...
const TYPE_MOVEMENT = array(
	...
	TYPE_MOVEMENT_REGULARIZE => 'COM_FOODMAN_TYPE_REGULARIZE',
	TYPE_MOVEMENT_MOVE       => 'COM_FOODMAN_TYPE_MOVE'
);
