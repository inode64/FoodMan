 ...
 * @since  1.6
 */
class FoodManModelCategory extends FoodManModelAdmin
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_foodman.category', 'category', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_foodman.edit.category.data', array());
		...
		$this->preprocessData('com_foodman.category', $data);
	...
	public function featured($pks, $value = 0)
	{
		...
		if (empty($pks))
		{
			$this->setError(JText::_('COM_FOODMAN_CATEGORY_NO_ITEM_SELECTED'));
		...
		try
		{
			...
			$query = $db->getQuery(true);
			$query->update('#__foodman_categories');
