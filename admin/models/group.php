 ...
 * @since  1.6
 */
class FoodManModelGroup extends FoodManModelAdmin
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_foodman.group', 'group', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_foodman.edit.group.data', array());
		...
		$this->preprocessData('com_foodman.group', $data);
	...
	public function featured($pks, $value = 0)
	{
		...
		if (empty($pks))
		{
			$this->setError(JText::_('COM_FOODMAN_GROUP_NO_ITEM_SELECTED'));
