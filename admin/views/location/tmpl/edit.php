...
<form action="<?php echo JRoute::_('index.php?option=com_foodman&view=location&layout=edit&id=' . (int) $this->item->id); ?>"
    ...
    <div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'locationTab', 'details', JText::_('COM_FOODMAN_LABEL_DETAILS')); ?>
        <div class="row-fluid">
            <div class="span9">
