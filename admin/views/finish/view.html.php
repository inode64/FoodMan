...
/**
 * View to edit a finish the lists.
 *
 * @since  1.5
 */
class FoodManViewFinish extends JViewLegacy
{
	/**
	 * The JForm object
	 *
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_FOODMAN_MANAGER_FINISH_NEW'), 'foodman fas fa-boxes');

		// If not checked out, can save the item.
		if ($canDo->get('core.edit'))
		{
			JToolbarHelper::apply('finish.apply');
		}

		JToolbarHelper::cancel('finish.cancel', 'JTOOLBAR_CLOSE');
	}
}
