 ...
 * @since  1.6
 */
class FoodManViewShoppings extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		FoodManHelper::addSubmenu('shoppings');
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.edit.state'))
		{
			if ($this->state->get('filter.published') != 2)
			{
				...
				JToolbarHelper::custom('shoppings.featured', 'featured.png', 'featured_f2.png', 'JFEATURE', true);
				JToolbarHelper::custom('shoppings.unfeatured', 'unfeatured.png', 'featured_f2.png', 'JUNFEATURE', true);
			}
