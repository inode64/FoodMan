 ...
 * @since  1.5
 */
class FoodManViewShop extends JViewLegacy
{
	/**
	 * The JForm object
	 *
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_FOODMAN_MANAGER_SHOP_NEW') : JText::_('COM_FOODMAN_MANAGER_SHOP_EDIT'), 'foodman fas fa-store-alt');
