 ...
 * @since  1.5
 */
class FoodManViewStock extends JViewLegacy
{
	/**
	 * The JForm object
	 *
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_FOODMAN_MANAGER_STOCK_NEW') : JText::_('COM_FOODMAN_MANAGER_STOCK_EDIT'), 'foodman fas fa-boxes');
