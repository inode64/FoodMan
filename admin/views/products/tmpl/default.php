...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_foodman&task=product.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'articleList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo JRoute::_('index.php?option=com_foodman&view=products'); ?>" method="post" name="adminForm"
      id="adminForm">
                    ...
                    <tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->id; ?>">
                        ...
                        <td class="center">
                            <div class="btn-group">
								...
								<?php echo JHtml::_('fmproduct.featured', $item->featured, $i, $canChange); ?>
                        ...
                        <td class="has-context">
                            <div class="pull-left break-word">
                                ...
                                <a href="<?php echo JRoute::_('index.php?option=com_foodman&task=product.edit&id=' . (int) $item->id); ?>">
