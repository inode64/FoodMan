...
<form action="<?php echo JRoute::_('index.php?option=com_foodman&view=category&layout=edit&id=' . (int) $this->item->id); ?>"
      method="post" name="adminForm" id="category-form" class="form-validate">

	<?php echo $this->form->renderField('name'); ?>

    <div class="form-horizontal">
		<?php echo JHtml::_('bootstrap.startTabSet', 'categoryTab', array('active' => 'details')); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'categoryTab', 'details', JText::_('COM_FOODMAN_LABEL_DETAILS')); ?>
        <div class="row-fluid">
            <div class="span9">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'categoryTab', 'otherparams', JText::_('COM_FOODMAN_CATEGORY_LABEL_DETAILS')); ?>
