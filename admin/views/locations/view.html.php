 ...
 * @since  1.6
 */
class FoodManViewLocations extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		FoodManHelper::addSubmenu('locations');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::_('COM_FOODMAN_MANAGER_LOCATIONS'), 'foodman fas fa-boxes');
		...
		if ($canDo->get('core.edit.state'))
		{
			...
			if ($this->state->get('filter.published') != -1)
			{
				...
				{
					JToolbarHelper::unarchiveList('locations.publish');
				}
			}
		}
