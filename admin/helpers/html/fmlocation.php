...
/**
 * JHtmlLocation HTML class.
 *
 * @since  2.5
 */
abstract class JHtmlFMLocation
{
	/**
	...
	public static function featured($value = 0, $i, $canChange = true)
	{
		...
		$states = array(
			0 => array('unfeatured', 'locations.featured', 'COM_FOODMAN_LOCATION_UNFEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
			1 => array('featured', 'locations.unfeatured', 'COM_FOODMAN_LOCATION_FEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
		);
