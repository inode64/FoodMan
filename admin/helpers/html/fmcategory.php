...
/**
 * JHtmlCategory HTML class.
 *
 * @since  2.5
 */
abstract class JHtmlFMCategory
{
	/**
	...
	public static function featured($value = 0, $i, $canChange = true)
	{
		...
		$states = array(
			0 => array('unfeatured', 'categories.featured', 'COM_FOODMAN_CATEGORY_UNFEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
			1 => array('featured', 'categories.unfeatured', 'COM_FOODMAN_CATEGORY_FEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
		);
