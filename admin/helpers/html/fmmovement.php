...
/**
 * JHtmlMovement HTML class.
 *
 * @since  2.5
 */
abstract class JHtmlFMMovement
{
	/**
	...
	public static function featured($value = 0, $i, $canChange = true)
	{
		...
		$states = array(
			0 => array('unfeatured', 'movements.featured', 'COM_FOODMAN_MOVEMENT_UNFEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
			1 => array('featured', 'movements.unfeatured', 'COM_FOODMAN_MOVEMENT_FEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
		);
