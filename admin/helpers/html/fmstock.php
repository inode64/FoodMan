...
/**
 * JHtmlStock HTML class.
 *
 * @since  2.5
 */
abstract class JHtmlFMStock
{
	/**
	...
	public static function featured($value = 0, $i, $canChange = true)
	{
		...
		$states = array(
			0 => array('unfeatured', 'stocks.featured', 'COM_FOODMAN_STOCK_UNFEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
			1 => array('featured', 'stocks.unfeatured', 'COM_FOODMAN_STOCK_FEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
		);
