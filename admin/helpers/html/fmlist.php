...
/**
 * JHtmlList HTML class.
 *
 * @since  2.5
 */
abstract class JHtmlFMList
{
	/**
	...
	public static function featured($value = 0, $i, $canChange = true)
	{
		...
		$states = array(
			0 => array('unfeatured', 'Lists.featured', 'COM_FOODMAN_LIST_UNFEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
			1 => array('featured', 'Lists.unfeatured', 'COM_FOODMAN_LIST_FEATURED', 'JGLOBAL_TOGGLE_FEATURED'),
		);
